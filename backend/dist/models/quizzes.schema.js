...
__decorate([
    (0, typeorm_1.ManyToOne)(() => modules_schema_1.Module, (module) => module.quizzes),
    __metadata("design:type", modules_schema_1.Module)
], Quiz.prototype, "module", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => responses_schema_1.Response, (response) => response.quiz),
    __metadata("design:type", Array)
