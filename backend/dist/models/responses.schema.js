...
__decorate([
    (0, typeorm_1.ManyToOne)(() => users_schema_1.User, (user) => user.responses),
    __metadata("design:type", users_schema_1.User)
], Response.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => quizzes_schema_1.Quiz, (quiz) => quiz.responses),
    __metadata("design:type", quizzes_schema_1.Quiz)
], Response.prototype, "quiz", void 0);
__decorate([
